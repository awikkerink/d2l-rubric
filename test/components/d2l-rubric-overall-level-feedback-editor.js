...
suite('<d2l-rubric-overall-level-feedback-editor>', function() {
	...
	suite('smoke test', function() {
		...
		test('can be instantiated', function() {
			...
			expect(element.is).to.equal('d2l-rubric-overall-level-feedback-editor');
		});
		...
		suite('edit feedback', function() {
			...
			test('saves feedback', function(done) {
				...
				raf(function() {
					element.addEventListener('d2l-rubric-overall-feedback-saved', function() {
